...
app.use("/callcenter_registro_investigar_nuevo", express.static(__dirname+'/dist'));
app.use("/callcenter_registro_canal_digital", express.static(__dirname+'/dist'));
app.use("/callcenter_registro_amarilo", express.static(__dirname+'/dist'));
...
app.use("/callcenter_estadisticas_investigar_nuevo", express.static(__dirname+'/dist'));
app.use("/callcenter_estadisticas_canal_digital", express.static(__dirname+'/dist'));
app.use("/callcenter_estadisticas_amarilo", express.static(__dirname+'/dist'));
...
app.use("/evento_estadisticas_bvc", express.static(__dirname+'/dist'));
app.use("/evento_estadisticas_arte_bolivar", express.static(__dirname+'/dist'));
