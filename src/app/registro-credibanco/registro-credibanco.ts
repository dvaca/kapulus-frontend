...
@Component({
  selector: 'app-registro-credibanco',
  templateUrl: './registro-credibanco.component.html',
  styleUrls: ['./registro-credibanco.component.css']
})
export class RegistroCredibancoComponent implements OnInit, OnChanges {
