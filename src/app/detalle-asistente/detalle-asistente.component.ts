...
export class DetalleAsistenteComponent implements OnInit, OnChanges, AfterViewInit {
  ...
  atributosForm = this.fb.group({
    identificacion: new FormControl(null, Validators.required),
    camposEvento: this.fb.group({
  ...
  loadForm() {
    //this.dynamicForm.controls.identificacion.setValue(this.asistente.identificacion);
    if (this.asistente && typeof this.asistente.identificacion!='undefined') {
      this.atributosForm.patchValue({ identificacion: [this.asistente.identificacion] });
    }
  }
