...
export class EstadisticasLocalComponent implements OnInit {
  ...
  ngOnInit() {
	...
	if(url == 'evento_estadisticas_infectologia'){
      this.cargarEvento(58, 58);
    }
	if(url == 'evento_estadisticas_corpochivor'){
      this.cargarEvento(61, 61);
    }
	if(url == 'evento_estadisticas_sic'){
      this.cargarEvento(62, 62);
    }
	if(url == 'evento_estadisticas_region_central'){
      this.cargarEvento(63, 63);
    }
	if(url == 'evento_estadisticas_canal_one'){
      this.cargarEvento(65, 65);
    }
